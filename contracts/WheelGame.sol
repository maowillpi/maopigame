...
contract WheelGame is ReentrancyGuard, Ownable {
    ...
    // MAO奖励配置 - 方案三优化版本
    uint256[7] public maoRewards = [
        0,            // 谢谢惠顾 68%
        110 * 10**18, // 安慰奖 110 MAO (14%)
        130 * 10**18, // 小奖 130 MAO (9%)
        200 * 10**18, // 中奖 200 MAO (5%)
        400 * 10**18, // 大奖 400 MAO (3%)
        800 * 10**18, // 超级大奖 800 MAO (0.8%)
        2000 * 10**18 // 终极大奖 2000 MAO (0.2%)
    ];
    
    // PI奖励配置 - 方案三优化版本（保持同样的倍数）
    uint256[7] public piRewards = [
        0,              // 谢谢惠顾 68%
        1100 * 10**18,  // 安慰奖 1100 PI (14%)
        1300 * 10**18,  // 小奖 1300 PI (9%)
        2000 * 10**18,  // 中奖 2000 PI (5%)
        4000 * 10**18,  // 大奖 4000 PI (3%)
        8000 * 10**18,  // 超级大奖 8000 PI (0.8%)
        20000 * 10**18  // 终极大奖 20000 PI (0.2%)
    ];
    
    // 概率区间 - 方案三优化版本
    uint256[7] public probabilityRanges = [
        6800,  // 谢谢惠顾 68%
        6800 + 1400,   // 安慰奖 14%
        6800 + 1400 + 900,  // 小奖 9%
        6800 + 1400 + 900 + 500,  // 中奖 5%
        6800 + 1400 + 900 + 500 + 300,  // 大奖 3%
        6800 + 1400 + 900 + 500 + 300 + 80,  // 超级大奖 0.8%
        10000  // 终极大奖 0.2%
    ];
