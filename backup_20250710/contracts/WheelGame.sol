...
contract WheelGame is ReentrancyGuard, Ownable {
    ...
    uint256[7] public maoRewards = [
        0,            // 谢谢惠顾 60%
        25 * 10**18,  // 安慰奖 25 MAO (16%)
        80 * 10**18,  // 小奖 80 MAO (12%)
        200 * 10**18, // 中奖 200 MAO (8%)
        500 * 10**18, // 大奖 500 MAO (3%)
        1000 * 10**18, // 超级大奖 1000 MAO (0.9%)
        2000 * 10**18  // 终极大奖 2000 MAO (0.1%)
    ];
    
    // PI奖励配置 - 优化整数版本  
    uint256[7] public piRewards = [
        0,               // 谢谢惠顾 60%
        250 * 10**18,    // 安慰奖 250 PI (16%)
        800 * 10**18,    // 小奖 800 PI (12%)
        2000 * 10**18,   // 中奖 2000 PI (8%)
        5000 * 10**18,   // 大奖 5000 PI (3%)
        10000 * 10**18,  // 超级大奖 10000 PI (0.9%)
        20000 * 10**18   // 终极大奖 20000 PI (0.1%)
    ];
    ...
    uint256[7] public probabilityRanges = [
        6000,  // 谢谢惠顾 60%
        6000 + 1600,   // 安慰奖 16%
        6000 + 1600 + 1200,  // 小奖 12%
        6000 + 1600 + 1200 + 800,  // 中奖 8%
        6000 + 1600 + 1200 + 800 + 300,  // 大奖 3%
        6000 + 1600 + 1200 + 800 + 300 + 90,  // 超级大奖 0.9%
        10000  // 终极大奖 0.1%
    ];
